<template>
  <span>
    <a @click="showImport">Export</a>
    <a-modal title="Export" v-model="visible" :footer="null">
      <a-form-model :model="form">
        ...
        <a-button type="primary" @click="handleImport">Export</a-button>
      </a-form-model>
    </a-modal>
  </span>
</template>
...
export default {
  ...
  methods: {
    ...
    async handleImport() {
      ...
      await axios.post("http://localhost:5000/warehouse/export", {
        SourceWhId,
        productItems
      });
      this.form = initForm;
